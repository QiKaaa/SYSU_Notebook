...
constexpr int SIZE = 1255;
constexpr int SIZE2 = 2055;
// 大数运算在2^32进制下进行
struct abc {
	int l;
	unsigned int num[SIZE]{};
	static int OB[SIZE2],NB[SIZE2],tmp[SIZE2];
	abc() {
...
char p[SIZE2],n[SIZE2],a[SIZE2],b[SIZE2];
int abc::tmp[SIZE2];
int abc::NB[SIZE2];
int abc::OB[SIZE2];
abc P,N,A,B,X;
int _2x[SIZE2], _10x[SIZE2], tmp[SIZE2];
int _2l, _10l;
void To2(const abc &x) {
	memset(_2x,0,sizeof(_2x));
	_2l = 0;
	For(i, 0, x.len() - 1) {
		For(j, 0, 31) {
